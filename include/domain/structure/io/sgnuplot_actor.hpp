...
template<class ANY>
spGnuplotActor _ToGnuplotActorLinesDim(const ANY& grid, SGridTag, Dim1Tag){
    spGnuplotActor actor = spGnuplotActor(new GnuplotActor());
...
template<class ANY>
spGnuplotActor _ToGnuplotActorLinesDim(const ANY& grid, SGridTag, Dim2Tag){
    spGnuplotActor actor = spGnuplotActor(new GnuplotActor());
    actor->command() = "using 1:2 title \"\" ";
    actor->style()   = "with line lc 0";
...
template<class ANY>
spGnuplotActor _ToGnuplotActorLines(const ANY& a, SGridTag){
