...
template<class VT, class GRID, class GHOST, class ORDER>
class LaplacianImplement_<1, VT, GRID, GHOST, ORDER, StructureType>: public SOperatorCommon_<1, VT, GRID, GHOST, ORDER>{
public:
    LaplacianImplement_(){
        std::cout << "Laplacian Structure 1" << std::endl;
    };
