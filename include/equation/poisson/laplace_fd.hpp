#ifndef _LAPLACE_FD_HPP_
#define _LAPLACE_FD_HPP_
...
public:
    LaplaceImpl_(spGrid spg, spGhost spgh, spOrder spo):
        Base(spg, spgh, spo){
            this->new_field("phi");
    }
    ...
    virtual int initialize(){
        ...
        if(! this->has_config("space_scheme")){  // set default space scheme
            this->set_space_scheme("finite_difference_2");  
        }
        return 0;
    }; 
    ...
    void set_phi(spFieldVertex spphi){
