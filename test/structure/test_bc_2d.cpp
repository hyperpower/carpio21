...
TEST(s_bc2d, dim2){
    ...
    typedef StructureDomain_<2, Grid, Ghost, Order> Domain; 
    typedef typename Domain::FieldCenterExp FieldExp;
    ...
    auto spfexp = Domain::NewspFieldCenterExpCoeOne(spgrid, spghost, sporder);
    ...
    std::cout << (*spfexp)(Index(1,1))<< std::endl;

    auto res = DifferenialLaplacianHOC4(*spfexp, bi, 0.0);
    ...
    gnu.set_terminal_png(FIG_PATH + "bc_2d", 
