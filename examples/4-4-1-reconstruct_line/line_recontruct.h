#ifndef _EXAMPLE_LINE_RECONTRUCT_H_
#define _EXAMPLE_LINE_RECONTRUCT_H_
...
inline void PlotReconstructedInterface(
    ...
    aline.line_color_red().line_width(3);
...
inline void ReconstructSolver(const std::string& method, int n,
                              ...
                              std::list<double>& l2,
                              std::list<double>& li) {
    std::cout << "[  PLIC  ] Reconstruct line" << std::endl;
